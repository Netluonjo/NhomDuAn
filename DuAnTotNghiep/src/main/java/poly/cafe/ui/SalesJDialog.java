...
@Override
    public void open() {
        this.setSize(750, 500); // Đặt kích thước 400x400
        this.setLocationRelativeTo(null);
    ...
    private JButton createButton(Card card) {
        ...
        } else if (servicingBill == null || billDetailDAO.findByBillId(servicingBill.getId()).isEmpty()) {
            btnCard.setBackground(Color.GREEN); // Thẻ hoạt động, trống
        } else if (servicingBill.getStatus() == Bill.Status.Servicing) {
            btnCard.setBackground(Color.RED); // Thẻ có bill chưa thanh toán
        } else {
            btnCard.setBackground(Color.GREEN); // Có bill nhưng đã thanh toán
        }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pnlCard, javax.swing.GroupLayout.PREFERRED_SIZE, 717, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pnlCard, javax.swing.GroupLayout.PREFERRED_SIZE, 441, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
